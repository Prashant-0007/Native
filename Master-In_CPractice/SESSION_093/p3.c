...
void comp_decl_2(void)
{
    // Declare a pointer to array of pointer to function accepting 
    //  two int and returning an integer 

    // p is a pointer :     *p
    // p is poniter to array 5:    (*p)[5]
    // p is pointer to array 5 of pointer to :      *(*p)[5]
    // p is pointer to array 5 of pointer to function:      (*(*p)[5])  ()
    //  p is pointer to array 5 of pointer to function accepting two int 
    //      int (*(*p)[5])(int, int); 
